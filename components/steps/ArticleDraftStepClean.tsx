            ...
            <div className="space-y-4">
              ...
              <div className="bg-blue-50 rounded-lg p-4">
                ...
                <p className="text-sm text-blue-800 mb-3">
                  Start a new chat in the OutreachLabs Guest Posts project with GPT-o3 Advanced Reasoning:
                </p>
                ...
                <p className="text-xs text-blue-700 mt-2 italic">Note: Must be logged into info@onlyoutreach.com</p>
              </div>
