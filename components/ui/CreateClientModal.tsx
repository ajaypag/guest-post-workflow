    ...
    try {
      ...
      if (response.ok) {
        ...
        if (selectedPath === 'send_invitation' && invitationSent) {
          ...
          // For existing account, just close and notify parent
          onClientCreated(client);
          onClose();
        }
      } else {
        ...
        <div className="bg-white rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
          ...
          <form onSubmit={handleSubmit} className="p-6">
            ...
            {!selectedPath && userType === 'internal' && (
              <div className="mb-6">
                <h3 className="text-lg font-semibold mb-4 text-gray-900">How would you like to create this client?</h3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  >
                    <div className="flex flex-col items-center text-center">
                      <div className="p-2 bg-blue-100 rounded-full mb-3 group-hover:bg-blue-200 transition-colors">
                        <User className="h-6 w-6 text-blue-600" />
                      </div>
                      <h4 className="font-semibold text-sm mb-2 text-gray-900">For Existing Account</h4>
                  ...
                  >
                    <div className="flex flex-col items-center text-center">
                      ...
                      <h4 className="font-semibold text-sm mb-2 text-gray-900">Send Invitation</h4>
                      <p className="text-xs text-gray-600">
                  ...
                  >
                    <div className="flex flex-col items-center text-center">
                      ...
                      <h4 className="font-semibold text-sm mb-2 text-gray-900">Generate Share Link</h4>
                      <p className="text-xs text-gray-600">
              ...
              <>
                      ...
                      <div className="space-y-2 max-h-48 overflow-y-auto">
                        {filteredAccounts.map(account => (
                          ...
                          >
                            ...
                            />
                            <div>
                              <div className="font-medium text-sm">{account.name || account.contactName}</div>
                              <div className="text-xs text-gray-600">{account.email}</div>
                            </div>
                          </label>
                        ))}
                        {filteredAccounts.length === 0 && (
                          <p className="text-gray-500 text-center py-4 text-sm">No accounts found</p>
                        )}
                      </div>
                    )}
                  </div>
                ...
                <div className="flex justify-end gap-4 pt-4 border-t">
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 font-medium disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2 transition-colors"
                  >
                    {loading ? (
                      <>
