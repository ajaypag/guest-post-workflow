...
// Reusable saved field display component
const SavedField = ({ 
  label, 
  value, 
  placeholder, 
...
const stepForms: Record<string, React.FC<{ step: WorkflowStep; workflow: GuestPostWorkflow; onChange: (data: any) => void }>> = {
  ...
  'keyword-research': ({ step, workflow, onChange }) => {
    // The parent component passes localOutputs as step.outputs
    // So step.outputs here is actually the local state, not the saved data
    console.log('keyword-research step.outputs:', step.outputs);
