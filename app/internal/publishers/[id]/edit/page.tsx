...
import { ArrowLeft, Save, AlertCircle, Building, User, Mail, Phone, Globe, MapPin, Settings } from 'lucide-react';
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="bg-white shadow-sm rounded-lg border border-gray-200">
            <div className="px-6 py-4 border-b border-gray-200">
              ...
              <p className="text-sm text-gray-600 mt-1">Company and contact details</p>
            </div>
            <div className="p-6">
          ...
          <div className="bg-white shadow-sm rounded-lg border border-gray-200">
            <div className="px-6 py-4 border-b border-gray-200">
              ...
              <p className="text-sm text-gray-600 mt-1">Verification and status management</p>
            </div>
            <div className="p-6">
          ...
          <div className="bg-white shadow-sm rounded-lg border border-gray-200">
            <div className="px-6 py-4 border-b border-gray-200">
              ...
              <p className="text-sm text-gray-600 mt-1">Physical location details (optional)</p>
            </div>
            <div className="p-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="md:col-span-2">
