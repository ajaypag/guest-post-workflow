                      ...
                      >
                        <div className="flex-1">
                          <div className="flex items-center gap-3 mb-1">
                            ...
                            <span className="font-medium text-gray-900">{task.domain_info}</span>
                          ...
                          <div className="flex gap-4 text-sm text-gray-600 ml-7">
                            <span className="font-medium text-gray-900"><Clock className="inline w-3 h-3 mr-1" />{task.datetime_posted_formatted}</span>
                            <span>{task.time}</span>
                            <span>{task.cost_formatted}</span>
                            {task.path?.[0] && <span className="text-xs text-gray-500">{task.path[0]}</span>}
                          </div>
