...
export default function FollowUpEmailPage() {
  return (
    <BlogPostTemplate
      ...
      metaDescription="Effective follow-up email templates for link building"
      publishDate="August 24, 2022"
      author="Ajay Paghdal"
      readTime="5 min read"
    >
      <div className="bg-gray-100 rounded-lg p-6 mb-8">
        ...
        <ul className="space-y-2 text-sm text-gray-700">
          <li><a href="#1-how-many-follow-ups-would-be-too-many-" className="hover:text-blue-600">1. How many follow-ups would be TOO many?</a></li>
          <li><a href="#2-is-the-fortune-in-follow-ups-as-they-say-" className="hover:text-blue-600">2. Is the fortune in follow-ups, as they say?</a></li>
          <li><a href="#3-are-you-supposed-to-get-a-response-to-your-follow-ups-" className="hover:text-blue-600">3. Are you supposed to get a response to your follow-ups?</a></li>
          <li><a href="#4-should-you-follow-up-after-rejection-or-let-it-go-" className="hover:text-blue-600">4. Should you follow up after rejection or let it go?</a></li>
          <li><a href="#5-how-to-send-a-follow-up-email-to-a-busy-person" className="hover:text-blue-600">5. How to send a follow-up email to a busy person</a></li>
          <li><a href="#6-when-is-it-legitimate-to-follow-up-early-" className="hover:text-blue-600">6. When is it legitimate to follow up early?</a></li>
          <li><a href="#7-how-to-shift-focus-from-the-flop-of-your-original-email" className="hover:text-blue-600">7. How to shift focus from the flop of your original email</a></li>
          <li><a href="#8-what-to-say-in-a-follow-up-coming-in-a-new-thread" className="hover:text-blue-600">8. What to say in a follow-up coming in a new thread</a></li>
          <li><a href="#9-how-not-to-start-a-follow-up-email" className="hover:text-blue-600">9. How NOT to start a follow-up email</a></li>
          <li><a href="#10-is-it-a-good-idea-to-use-humor-in-follow-ups-" className="hover:text-blue-600">10. Is it a good idea to use humor in follow-ups?</a></li>
          <li><a href="#11-should-you-be-a-bit-pushy-for-your-follow-ups-to-work-" className="hover:text-blue-600">11. Should you be a bit pushy for your follow-ups to work?</a></li>
          <li><a href="#12-should-you-apologize-for-following-up-out-of-politeness-" className="hover:text-blue-600">12. Should you apologize for following up (out of politeness)?</a></li>
          <li><a href="#13-do-personalized-follow-ups-always-feel-right-" className="hover:text-blue-600">13. Do personalized follow-ups always feel right?</a></li>
          <li><a href="#14-how-to-write-a-value-added-follow-up" className="hover:text-blue-600">14. How to write a value-added follow-up</a></li>
          <li><a href="#15-what-if-you-can-t-add-more-value-to-each-follow-up-" className="hover:text-blue-600">15. What if you can’t add more value to each follow-up?</a></li>
          <li><a href="#16-is-it-ok-to-go-off-topic-when-following-up-" className="hover:text-blue-600">16. Is it OK to go off-topic when following up?</a></li>
          <li><a href="#17-how-to-follow-up-publicly-the-right-way" className="hover:text-blue-600">17. How to follow up publicly the right way</a></li>
          <li><a href="#18-should-you-load-your-follow-up-with-attachments-" className="hover:text-blue-600">18. Should you load your follow-up with attachments?</a></li>
          <li><a href="#19-can-your-connections-help-you-with-follow-ups-" className="hover:text-blue-600">19. Can your connections help you with follow-ups?</a></li>
          <li><a href="#20-do-you-breach-follow-up-etiquette-with-social-proof-" className="hover:text-blue-600">20. Do you breach follow-up etiquette with social proof?</a></li>
          <li><a href="#21-how-to-follow-up-with-people-who-repeatedly-opened-your-email" className="hover:text-blue-600">21. How to follow up with people who repeatedly opened your email</a></li>
          <li><a href="#22-should-people-know-you-saw-them-opening-your-email-" className="hover:text-blue-600">22. Should people know you saw them opening your email?</a></li>
          <li><a href="#23-how-to-follow-up-with-editors-uninterested-in-your-pitch" className="hover:text-blue-600">23. How to follow up with editors uninterested in your pitch</a></li>
          <li><a href="#24-how-to-send-the-last-follow-up-without-burning-bridges" className="hover:text-blue-600">24. How to send the last follow-up without burning bridges</a></li>
          <li><a href="#25-will-bad-follow-ups-discredit-you-in-public-" className="hover:text-blue-600">25. Will bad follow-ups discredit you in public?</a></li>
      ...
      <div className="prose prose-lg max-w-none">
        ...
        <ul className="list-disc pl-6 space-y-2">
          ...
          <li>2. Is the fortune in follow-ups, as they say?</li>
          <li>3. Are you supposed to get a response to your follow-ups?</li>
          <li>4. Should you follow up after rejection or let it go?</li>
          <li>5. How to send a follow-up email to a busy person</li>
          <li>6. When is it legitimate to follow up early?</li>
          <li>7. How to shift focus from the flop of your original email</li>
          <li>8. What to say in a follow-up coming in a new thread</li>
          <li>9. How NOT to start a follow-up email</li>
          <li>10. Is it a good idea to use humor in follow-ups?</li>
          <li>11. Should you be a bit pushy for your follow-ups to work?</li>
          <li>12. Should you apologize for following up (out of politeness)?</li>
          <li>13. Do personalized follow-ups always feel right?</li>
          <li>14. How to write a value-added follow-up</li>
          <li>15. What if you can’t add more value to each follow-up?</li>
          <li>16. Is it OK to go off-topic when following up?</li>
          <li>17. How to follow up publicly the right way</li>
          <li>18. Should you load your follow-up with attachments?</li>
          <li>19. Can your connections help you with follow-ups?</li>
          <li>20. Do you breach follow-up etiquette with social proof?</li>
          <li>21. How to follow up with people who repeatedly opened your email</li>
          <li>22. Should people know you saw them opening your email?</li>
          <li>23. How to follow up with editors uninterested in your pitch</li>
          <li>24. How to send the last follow-up without burning bridges</li>
          <li>25. Will bad follow-ups discredit you in public?</li>
          <li>The idea to follow up on an email that got no reply is as old as time.</li>
          <li>Or at least as the web.</li>
          <li>I’m not gonna tell you for the billionth time that follow-ups increase response rates. Many gurus and studies have done it for me.</li>
          <li>I wanna talk about another side to the story, usually unreported.</li>
          <li>Along with a growth of response rates, the number of spam reports on each consecutive follow-up you send grows too. Unfortunately, there’s currently no tool that would let us collect stats on this. What happens in someone’s inbox remains in their inbox.</li>
          <li>But the reality is a good portion of outreach emails land in my spam folder.</li>
          <li>No, they don’t have any spam triggers like “buy now” or “discount.” And I must admit I occasionally see quite good emails there. Still, they go directly to spam and do it for a reason. Their senders must have abused outreach tactics earlier, which annoyed recipients to the point that they started reporting spam on them.</li>
          <li>And criticism from social media only proves it.</li>
          <li>Source</li>
          <li>Do you get what I’m saying?</li>
          <li>While a lot of follow-up tips sound promising, they don’t always have the outcomes promised.</li>
          <li>Let’s dig deeper into controversies about follow-ups, based on the feedback from people who receive them all the time. Their insights should help you understand how to follow up on an email the right way.</li>
        </ul>

        <h2 id="1-how-many-follow-ups-would-be-too-many-">1. How many follow-ups would be TOO many?</h2>

        <p>Gurus say you should create an entire sequence of follow-ups. Opinions differ on the exact number, but I’ve seen suggestions of up to nine follow-ups.
...
To be honest, there’s an unspoken rule to use a different domain for outreach, e.g. name@company.tech instead of name@company.com. It can help you secure your domain reputation against spam reports, but certainly not the reputation of your brand.</p>

        <h2 id="2-is-the-fortune-in-follow-ups-as-they-say-">2. Is the fortune in follow-ups, as they say?</h2>

        <p>Gurus say the fortune is in follow-ups.
...
In general, I can think of only one legitimate reason to go beyond one follow-up – offering different or more value each time. Sending reminders about the same stuff over and over is a dead-end job.</p>

        <h2 id="3-are-you-supposed-to-get-a-response-to-your-follow-ups-">3. Are you supposed to get a response to your follow-ups?</h2>

        <p>Gurus say you should keep on following up until you get a response.
Any response…
...
Source</p>
        ...
        <h2 id="4-should-you-follow-up-after-rejection-or-let-it-go-">4. Should you follow up after rejection or let it go?</h2>

        <p>Gurus say you shouldn’t give up on editors who rejected your original pitch.
...
Spell out what benefits editors will reap from your submission.</p>

        <h2 id="5-how-to-send-a-follow-up-email-to-a-busy-person">5. How to send a follow-up email to a busy person</h2>

        <p>Gurus say you shouldn’t delay following up for too long, until better times.
...
Thinking they need to decide right away, busy folks will find it easier to reject your pitch rather than give it some thought.</p>

        <h2 id="6-when-is-it-legitimate-to-follow-up-early-">6. When is it legitimate to follow up early?</h2>

        <p>Gurus say you can’t follow up with editors the day after you sent your first email.
...
To make sure they don’t see you as another inbox pest, emphasize that you pitch the breaking news. That’s why it makes sense to get it published before the buzz ends.</p>

        <h2 id="7-how-to-shift-focus-from-the-flop-of-your-original-email">7. How to shift focus from the flop of your original email</h2>

        <p>Gurus say you can’t tell recipients that you’re following up.
...
My point is you can’t heavily rely on templates you found on Google. Others use them too, and people are getting more and more reluctant to read emails with opening lines they’ve seen like a hundred times before</p>

        <h2 id="8-what-to-say-in-a-follow-up-coming-in-a-new-thread">8. What to say in a follow-up coming in a new thread</h2>

        <p>I still wonder what to say when you follow up in a new thread.
...
It focuses on adding value.</p>

        <p>Too often, sales reps treat a follow-up email as simply a way to bump the thread to the top of the inbox. But all that does is remind the prospect they most likely weren’t interested in the first place.
...
All they do is change a word or two in the subject line and a few words across the message, but the key point remains the same. It can hardly feel like a fresh start – these are just reminders about the same email campaign that didn’t work out.</p>

        <h2 id="9-how-not-to-start-a-follow-up-email">9. How NOT to start a follow-up email</h2>

        <p>Gurus say you should avoid cliches like “just checking in” or “just pinging you.”
...
But on their end, your message won’t sound as if it’s just a reminder, not something important to respond to asap.</p>

        <h2 id="10-is-it-a-good-idea-to-use-humor-in-follow-ups-">10. Is it a good idea to use humor in follow-ups?</h2>

        <p>Gurus say you should use humor to relieve the tension in overloaded inboxes. It’s more enjoyable to chat with a funny person than some whiner, after all.
...
Assuming your joke is creative, it may bring a smile to the face of a person who’s doing great. But how about someone who’s having a hard time, not necessarily at work? Your attempts to sound funny can only enrage them.</p>

        <h2 id="11-should-you-be-a-bit-pushy-for-your-follow-ups-to-work-">11. Should you be a bit pushy for your follow-ups to work?</h2>

        <p>Gurus say you’ll sometimes need to push recipients for them to write you back.
Just a little…
...
Source</p>
        ...
        <h2 id="12-should-you-apologize-for-following-up-out-of-politeness-">12. Should you apologize for following up (out of politeness)?</h2>

        <p>Gurus say you should be polite and say you’re sorry for messaging people again.
...
Source</p>
        ...
        <h2 id="13-do-personalized-follow-ups-always-feel-right-">13. Do personalized follow-ups always feel right?</h2>

        <p>Gurus say you should mention something from your prospects’ social accounts in a follow-up.
...
Keep comments on their personal stuff like tattoos for later, when you get better acquainted with each other.</p>

        <h2 id="14-how-to-write-a-value-added-follow-up">14. How to write a value-added follow-up</h2>

        <p>Gurus say you should add extra value to each follow-up.
...
• showing how their product can solve issues on a webinar.</p>

        <h2 id="15-what-if-you-can-t-add-more-value-to-each-follow-up-">15. What if you can’t add more value to each follow-up?</h2>

        <p>I still wonder if it’s realistic to increase the value each time you follow up.
...
Also note that even a value-added follow-up doesn’t guarantee a reply, especially if your outreach is cold. You’ll probably get more rewards for featuring your current partner on a top niche blog rather than wasting this opportunity on a stranger who won’t get back to you anyway.</p>

        <h2 id="16-is-it-ok-to-go-off-topic-when-following-up-">16. Is it OK to go off-topic when following up?</h2>

        <p>Gurus say you should add more interest to your follow-ups.
...
Instead of telling prospects about your anticipation (who cares?), deliver them the news that would spark their reaction.</p>

        <h2 id="17-how-to-follow-up-publicly-the-right-way">17. How to follow up publicly the right way</h2>

        <p>Gurus say you should follow up with editors on social media if they don’t reply by email.
...
• They were not the only ones who ignored your pitch and probably did the right thing if many others did the same.</p>

        <h2 id="18-should-you-load-your-follow-up-with-attachments-">18. Should you load your follow-up with attachments?</h2>

        <p>Gurus say you should include attachments or links to something interesting in follow-ups.
...
What could get them hooked is a post with a new link building tactic no one talked about before or a study debunking commonly suggested tips.</p>

        <h2 id="19-can-your-connections-help-you-with-follow-ups-">19. Can your connections help you with follow-ups?</h2>

        <p>Gurus say you should introduce your prospects to a useful business contact.
...
Ask that “useful contact” in advance which of your prospects they won’t mind dealing with. For example, if they publish guest posts, there’s no way they’ll want to accept them from each and every person on your outreach list.</p>

        <h2 id="20-do-you-breach-follow-up-etiquette-with-social-proof-">20. Do you breach follow-up etiquette with social proof?</h2>

        <p>Gurus say you should drop names to add a sense of authority to your follow-ups.
...
Being associated with spammers isn’t cool, I guess.</p>

        <h2 id="21-how-to-follow-up-with-people-who-repeatedly-opened-your-email">21. How to follow up with people who repeatedly opened your email</h2>

        <p>Gurus say you need a different follow-up approach to people who reread your pitch many times.
...
• if they have any questions about some specific part of your copy.</p>

        <h2 id="22-should-people-know-you-saw-them-opening-your-email-">22. Should people know you saw them opening your email?</h2>

        <p>Gurus say you should use recipients’ behavioral actions as your follow-up excuse.
...
Someone carefree will probably not read too much into your statement. But tell it to a sensitive person, and they’ll wonder if you have any shame to capitalize on their private actions.</p>

        <h2 id="23-how-to-follow-up-with-editors-uninterested-in-your-pitch">23. How to follow up with editors uninterested in your pitch</h2>

        <p>Gurus say you should add more arguments in favor of your pitch each time you follow up. The fact that editors ignored it means your reasoning wasn’t convincing enough.
...
Your alternative pitch should be based on learning from mistakes, not guesswork.</p>

        <h2 id="24-how-to-send-the-last-follow-up-without-burning-bridges">24. How to send the last follow-up without burning bridges</h2>

        <p>Gurus say you should send a “breakup email” after a few unsuccessful follow-ups.
...
Let this outreach episode end on a cliffhanger.</p>

        <h2 id="25-will-bad-follow-ups-discredit-you-in-public-">25. Will bad follow-ups discredit you in public?</h2>

        <p>Gurus never say that your follow-ups can end up on the public wall of shame, e.g. in someone’s social thread.
...
The bottom line?
Even with noble intentions, your prospects can make you famous.</p>

        <h3 id="final-word">Final Word</h3>

        <p>I’m not against gurus and what they preach. Their follow-up tips probably worked for them and, in all honesty, helped me a lot in my early days.
...
If you have any questions or disagree with something you’ve just read, feel free to tweet to @NickCampbelll.</p>
