...
export default function HowToWriteEmailOutreachPitchPage() {
  return (
    <BlogPostTemplate
      title="How To Write Email Outreach Pitch"
      metaDescription="Learn more about how to write email outreach pitch"
    ...
    >
      <div className="bg-gray-100 rounded-lg p-6 mb-8">
        ...
        <ul className="space-y-2 text-sm text-gray-700">
          <li><a href="#how-to-write-email-subject-lines-that-get-opened" className="hover:text-blue-600">How to write email subject lines that get opened</a></li>
          <li><a href="#what-is-the-correct-email-format-in-outreach" className="hover:text-blue-600">What is the correct email format in outreach</a></li>
          <li><a href="#how-to-structure-an-email-pitch" className="hover:text-blue-600">How to structure an email pitch</a></li>
          <li><a href="#how-to-personalize-email-pitches" className="hover:text-blue-600">How to personalize email pitches</a></li>
          <li><a href="#how-to-increase-email-response-rates" className="hover:text-blue-600">How to increase email response rates</a></li>
          <li><a href="#outreach-email-templates-to-get-links" className="hover:text-blue-600">Outreach email templates to get links</a></li>
      ...
      <div className="prose prose-lg max-w-none">
        ...
        <ul className="list-disc pl-6 space-y-2">
          ...
          <li>What is the correct email format in outreach</li>
          <li>How to structure an email pitch</li>
          <li>How to personalize email pitches</li>
          <li>How to increase email response rates</li>
          <li>Outreach email templates to get links</li>
          <li>Final Word</li>
          <li>Let me read your mind about the last outreach email you wrote and sent.</li>
          <li>You found some template in Google, made a few quick edits, sent your pitch to many recipients, and ended up with results as if you did no outreach at all. If you’re not your own boss, you must have felt ashamed to report such a “progress” to your manager.</li>
          <li>How do I know?</li>
          <li>Mind-reading is not my thing. It’s just what happens to many outreachers, basically for two reasons:</li>
          <li>their content sucks;</li>
          <li>their outreach email sucks.</li>
          <li>If your content takes you down, check out this guide.</li>
          <li>If the problem is your message, read on.</li>
          <li>For years, I’ve received tons of email pitches made wrong and, truth be told, sent no better pitches myself. No friendly tone, no decent personalization, no emphasis on the value for recipients…</li>
          <li>I bet that’s exactly what you’re missing too.</li>
          <li>Let me guide you on how to write an outreach email pitch with all the key points in mind. At the end of the day, you should get closer to your prospects and further away from their spam folders.</li>
          <li>But before I start talking about how to write an email outreach pitch, I want you to promise one thing – you will not send spam emails to anyone no matter how tempting it might be.</li>
          <li>Yeah, you probably nod your head and say you’re not sending spam emails, but in practice, you still do so. Remember when you last opened a spammy email? What did it feel like? What did you do right after?</li>
          <li>Don’t make others feel the same way!</li>
          <li>OK, now let’s get back to the guide on how to write a great outreach email.</li>
        </ul>

        <h2 id="how-to-write-email-subject-lines-that-get-opened">How to write email subject lines that get opened</h2>

        <p>The first roadblock on your way to a successful email marketing campaign is your subject line.
...
Check out the best practices for cold email subject lines. I included those that helped me increase the open rates of my letters.</p>
...
Forcing people to make such guesses is nothing but bad manners. It can also give them a feeling that your pitch is one of many other spam emails landing in their inboxes day in, day out.</p>

        <h3 id="avoid-capitalization-in-email-subject-lines">Avoid capitalization in email subject lines</h3>

        <p>Problem. A lot of personal outreach emails remain unnoticed because they look like automated newsletters.
...
Shorten post titles to keywords only. That’d be enough to let your prospects know which post is on your mind.</p>

        <h3 id="arouse-some-curiosity-with-your-email-subject-line">Arouse some curiosity with your email subject line</h3>
...
Also, your question will make more sense in the context of your arguments rather than on its own.</p>

        <h3 id="accentuate-the-value-for-your-outreach-prospects">Accentuate the value for your outreach prospects</h3>

        <p>Problem. People skip many outreach emails because they don’t see any value there. Just another hard sell or stuff like that.
Can you blame them?
...
Another way to increase email deliveribility rate and boost the email credibility is by securing your email domain. You can check your email security compliances with an email header analyzer.</p>

        <h3 id="get-straight-to-the-point-in-your-email-subject-line">Get straight to the point in your email subject line</h3>
...
It was the last of my email subject line tips for you. For more inspiration, check out this cool post with currently 164 ideas on the list.</p>

        <h2 id="what-is-the-correct-email-format-in-outreach">What is the correct email format in outreach</h2>

        <p>Once your subject line passes face control, your outreach prospects will open your email where things usually go wrong.
...
However, it is important to learn how to format an email pitch in a way to retain your prospects at this to-read-or-not-to-read stage.</p>

        <h3 id="stick-to-a-non-promotional-email-design">Stick to a non-promotional email design</h3>
...
Pre-designed email templates are OK for newsletters. If you send them, feel free to use such templates without worries.</p>

        <h3 id="limit-your-email-length-to-a-few-short-paragraphs">Limit your email length to a few short paragraphs</h3>

        <p>Problem. When you open an outreach email and see a wall of text as below, do you want to read it?
...
Don’t let this blah-blah-blah disrupt your optimal email length and show yourself as talkative.</p>

        <h3 id="use-a-friendly-email-tone">Use a friendly email tone</h3>
...
Btw, if you think about retweeting your prospects’ posts a few days before emailing them, don’t bother 🙂 This manipulation would be too obvious.</p>

        <h3 id="spell-check-email-pitches-before-sending">Spell check email pitches before sending</h3>

        <p>Problem. Outreachers are usually quick to write an email pitch and hit the send button. It takes them only a few seconds to notice spelling mistakes afterward.
Oops…
...
Note. It’s OK to use colloquial speech (“ya” – “you,” “doin’” – “doing,” etc), even if your email spell checker highlights them as misspellings.</p>
        ...
        <h2 id="how-to-structure-an-email-pitch">How to structure an email pitch</h2>

        <p>As mentioned in the previous section, your outreach email should be short, basically around ten sentences.
...
Here are the main email parts you should include in your pitch.</p>

        <h3 id="email-greetings">Email greetings</h3>

        <p>Problem. When you don’t address your outreach prospects by name, it’s a red flag that your message ended up in hundreds of other mailboxes.
...
A proper email greeting is the easiest way of personalization but many outreachers still fail here.</p>

        <h3 id="email-opening-lines">Email opening lines</h3>

        <p>Problem. Email opening lines are notorious for being the most irrelevant part that recipients usually skip over.
...
But your email opener isn’t the right part to tell about your product USPs. You should mention them in a different part of an email, which you’ll learn about below.</p>

        <h3 id="outreach-excuse">Outreach excuse</h3>

        <p>Problem. The most important part of an email is your outreach excuse, the notion I first saw in this sarcastic post.
...
You can’t only indicate a problem without providing a solution. It’s just useless. You should also suggest a fresh alternative to the outdated stuff for the time being.</p>

        <h3 id="email-closing-lines">Email closing lines</h3>

        <p>Problem. Here comes a culmination of your outreach email, when you need to tell folks what you want.
...
Check out a few more things to make sure you don’t sabotage your outreach.</p>

        <h2 id="how-to-personalize-email-pitches">How to personalize email pitches</h2>

        <p>Ever felt a forbidden desire to stalk someone? This is your chance to fulfill it and, most importantly, to do it legally.
...
Here’s how to personalize emails based on those insights.</p>

        <h3 id="use-your-prospects-interests-for-email-personalization">Use your prospects’ interests for email personalization</h3>

        <p>Problem. Since we all hang out on social media today, it’s no big deal to check someone’s likes and dislikes. Everything is out in the open.
...
If it turns out that you know nothing but the name of his fav team, that’ll be a shame.</p>

        <h3 id="personalize-mass-emails-with-your-prospects-professional-activities">Personalize mass emails with your prospects’ professional activities</h3>

        <p>Problem. Showing interest in what your outreach prospects do as opposed to what they like, you can get even closer to them. But it’ll work only if you know a thing or two about their undertakings.
...
In her bio, Motoko says she’s been in search marketing since the mid-90s, which is like 25 years. Unless you can phrase your comment delicately, say nothing. Don’t accentuate anyone’s age, as it’ll sound offensive.</p>

        <h2 id="how-to-increase-email-response-rates">How to increase email response rates</h2>
...
Check out a few hacks to boost the response rates of your email pitches.</p>
...
Make sure you have the same name and avatar in your email and Twitter accounts. If you have a different pic in your mailbox, it may not ring a bell for them. All your efforts will be in vain.</p>

        <h3 id="do-what-your-outreach-prospects-ask">Do what your outreach prospects ask</h3>
...
Alexander’s interview was published more than a year ago, so it’s kinda too late to vote it up.</p>

        <h3 id="point-out-an-issue-on-your-outreach-prospect-s-site">Point out an issue on your outreach prospect’s site</h3>
...
But don’t be too technical. Otherwise, your message will look suspicious. People may wonder why you performed a technical audit of their site. How will you bluff it out?</p>

        <h3 id="link-out-to-your-outreach-prospects">Link out to your outreach prospects</h3>

        <p>Problem. The fact that you’ve linked to your outreach prospects will put your pitch over others. It’ll increase your email campaign response rates for sure.
...
• drive organic traffic, as they can bring you some referral traffic besides link juice.</p>

        <h3 id="share-your-product-with-your-outreach-prospects">Share your product with your outreach prospects</h3>

        <p>Problem. Having a product that you can share with your outreach prospects is such a privilege. But some outreachers leave me speechless because of their greed.
...
For more inspiration, check out cold email case studies with great reply rates.</p>

        <h2 id="outreach-email-templates-to-get-links">Outreach email templates to get links</h2>
...
For a full list, visit our email outreach templates page.</p>
        ...
        <p>I hope I could guide you on how to write an outreach email pitch at every stage. None of these strategies is rocket science. All you need is some wit and a lot of practice.
...
Do you have any questions about the whole process? Feel free to drop me an email, and I’ll try to help 🙂</p>
