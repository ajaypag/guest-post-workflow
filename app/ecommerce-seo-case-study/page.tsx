...
export const metadata = {
  title: "Ecommerce Seo Case Study | PostFlow",
  description: "Learn more about ecommerce seo case study",
};
...
export default function EcommerceSeoCaseStudyPage() {
  return (
    <BlogPostTemplate
      ...
      metaDescription="Learn more about ecommerce seo case study"
    ...
    >
      <div className="bg-gray-100 rounded-lg p-6 mb-8">
        ...
        <ul className="space-y-2 text-sm text-gray-700">
          <li><a href="#month-0-the-plan" className="hover:text-blue-600">Month 0: The Plan</a></li>
          <li><a href="#month-1-link-building-starts" className="hover:text-blue-600">Month 1: Link Building Starts</a></li>
          <li><a href="#month-2-lots-of-links-small-gains" className="hover:text-blue-600">Month 2: Lots of Links, Small Gains</a></li>
          <li><a href="#month-3-big-rankings-gains" className="hover:text-blue-600">Month 3: Big Rankings Gains</a></li>
          <li><a href="#month-4-growth-continues" className="hover:text-blue-600">Month 4: Growth Continues</a></li>
          <li><a href="#month-5-biggest-moves-upward" className="hover:text-blue-600">Month 5: Biggest Moves Upward</a></li>
          <li><a href="#month-6-so-far-so-good" className="hover:text-blue-600">Month 6: So Far so Good</a></li>
          <li><a href="#month-7-upward-trend-continues" className="hover:text-blue-600">Month 7: Upward Trend Continues</a></li>
      ...
      <div className="prose prose-lg max-w-none">
        <h1>Ecommerce SEO Case Study</h1>

        <ul className="list-disc pl-6 space-y-2">
          <li>Month 0: The Plan</li>
          <li>Month 1: Link Building Starts</li>
          <li>Month 2: Lots of Links, Small Gains</li>
          <li>Month 3: Big Rankings Gains</li>
          <li>Month 4: Growth Continues</li>
          <li>Month 5: Biggest Moves Upward</li>
          <li>Month 6: So Far so Good</li>
          <li>Month 7: Upward Trend Continues</li>
          <li>I’m starting my first e-commerce/dropshipping business and SEO will be my primary focus for the first year.</li>
          <li>And guess what?</li>
          <li>I’ll be documenting my entire strategy for you right on this page month over month as the brand goes from a zero-authority/no-traffic website to a page 1 ranking money making machine in under a year.</li>
          <li>It’s in the groomsmen gifts space. The website is groomsmengiftsource.com.</li>
          <li>I’m going to be sharing everything else in great detail. My exact strategy, how many links I built, and rankings movements over time.</li>
          <li>With the pre-amble out of the way, let’s dive in.</li>
          <li>To launch a successful e-commerce brand with SEO, you need the following:</li>
          ...
          <li>If you (yes, you beautiful), want to get your website on the first page of Google for [insert desired keyword] then what I’m about to outline is the only strategy you need to follow.</li>
        </ul>

        <h2 id="month-0-the-plan">Month 0: The Plan</h2>

        <p>Let’s start with knowing exactly what we’re up against.
...
In general, my 3 month goal is to build 100 dofollow contextual links and as many resource and niche-relevant directory links I can.</p>
        ...
        <h3 id="1-custom-blogger-outreach-guest-posting">1. Custom Blogger Outreach Guest Posting</h3>

        <p>Link building via blogger outreach is what we do at OutreachMama so I’m definitely going to go with my strength here.
...
What does matter to me is that the site is run by a real person. If it’s low authority or low traffic site, but in my niche, I’m happy with it.</p>

        <h3 id="2-directory-link-building">2. Directory Link Building</h3>

        <p>Directories are also quite big in the industry I’m in. As long as I don’t have to pay for it, and the directory site is niche, I’ll try to get websitename.com and naked URL placement. In month 2, I’ll cover this in greater detail.</p>

        <h3 id="3-resource-page-link-building">3. Resource Page Link Building</h3>

        <p>Resource page links are great. They’re niche relevant, usually contribute to my branded or URL anchor needs and the pages already have some age to them. I’ll share more about this strategy month 2.</p>

        <h3 id="end-of-month-stats">End of Month Stats</h3>

        <p>You still with me? Good.
...
That wraps up month 0. See you next month!</p>

        <h2 id="month-1-link-building-starts">Month 1: Link Building Starts</h2>
...
• 9 Directory Links
• 4 Resource Links
The discrepancy between my count and Ahref’s could have been dupe links or spam links.</p>

        <h3 id="how-i-built-the-26-guest-post-links">How I Built The 26 Guest Post Links</h3>

        <p>26 guest posts works out to about 1 a day. I asked the publishers to skip attribution where possible and most did. These were mostly low authority niche specific sites.
...
For outreach, I didn’t do anything special here besides building bulk prospecting lists > bulk finding email > bulk sending emails > bulk sending follow-ups and working with whoever shows interest.</p>

        <h3 id="how-i-built-the-9-directory-links">How I Built the 9 Directory Links</h3>

        <p>I scraped Google’s search results with 2 search operators.
– (Keyword) + directory
...
We scored 9 links in January and hoping for a few more in February. You can learn more about directory link building strategies here.</p>

        <h3 id="how-i-built-the-4-resource-links">How I Built The 4 Resource Links</h3>

        <p>I scraped Google’s search results with 2 search operators.
• (Keyword) inurl:resources
• (Keyword) inurl:links
That yielded 238 opportunities. We found the emails and sent them a pitch for inclusion.
30 people replied and got 4 links out of it. Maybe some more will arrive next month, not sure.</p>

        <h3 id="seo-rankings-update">SEO Rankings Update</h3>

        <p>The average ranking across 133 keywords went from nowhere to the average rank of 85 aka page 8.
...
Until next month – cheers!</p>

        <h2 id="month-2-lots-of-links-small-gains">Month 2: Lots of Links, Small Gains</h2>

        <p>Recapping May 2020 activities: Ahrefs shows a backlink profile growth to 87 links. We continued the same activities outlined in the earlier months with most of the links coming from blogger outreach.
The process here is very straight forward.
Prospect blogs in my niche, email 5 websites a day, follow-up with them up to 4 times, and publish content with the ones that say yes – hopefully without attribution.</p>

        <h3 id="rankings-update">Rankings Update</h3>

        <p>Our rankings went from average of position 85 to position 39 for 133 keywords.
My 3 “main” high volume keywords like groomsmen gifts, best groomsmen gifts, and groomsmen gift ideas moved from not top 100 to positions 50, 27 and 28 respectively. Two long tail keywords made it to the bottom of page 1 and most others are spread across pages 2-6.</p>

        <h2 id="month-3-big-rankings-gains">Month 3: Big Rankings Gains</h2>

        <p>June 2020 actually was not a great link acquision month. We only were able to build 2 link this month. Mostly this was due to a lack of focus across several key team members, including myself.
...
Until next month!</p>
        ...
        <h2 id="month-4-growth-continues">Month 4: Growth Continues</h2>

        <p>It’s the middle of the year and wedding season is in full effect. Well, it would have been if not for the pandemic. Regardless, we continue our hard work to get our groomsmen gifts such as Tissot watches easily.
...
My plan for month 5 is more of the same. Blog outreach for more homepage links from wedding blogs in articles talking about groomsmen gifts or more general wedding topics. Speak soon!</p>

        <h2 id="month-5-biggest-moves-upward">Month 5: Biggest Moves Upward</h2>

        <p>We’ve continued to see steady gains in rankings and traffic. Here are the month over month Ahrefs metrics gains.
...
That’s about it for now – see you next month!</p>
        ...
        <h2 id="month-6-so-far-so-good">Month 6: So Far so Good</h2>
...
That’s about it for now – see you next month!</p>
        ...
        <h2 id="month-7-upward-trend-continues">Month 7: Upward Trend Continues</h2>

        <p>Almost like clockwork, we’ve continued to see steady gains in rankings and traffic. Here are the month over month Ahrefs metrics gains.
...
That’s all for this month. Cheers.</p>
