...
export default function BestCitationBuildingServicesPage() {
  return (
    <BlogPostTemplate
      title="Best Citation Building Services (30+ Reviewed)"
      metaDescription="Comprehensive review of the top 30+ citation building services to help improve your local SEO."
      ...
      relatedPosts={[
        {
          title: "SEO Webinars",
          href: "/seo-webinars",
          description: "Watch our collection of SEO webinars"
        },
        {
