...
export const websites = pgTable('websites', {
  ...
  selectedOfferingId: uuid('selected_offering_id'), // The offering that was selected to provide the current guest_post_cost (for min/max strategies)
  selectedPublisherId: uuid('selected_publisher_id'), // The publisher who owns the selected offering
  selectedAt: timestamp('selected_at'), // When the offering was selected/price was calculated
